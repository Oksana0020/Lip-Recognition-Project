"""
Batch preprocess all videos in testing/my_sounds:
Extracts lip region using dlib facial landmarks
Saves cropped videos (64x64) to testing/my_sounds_cropped_videos
"""
...
def main():
    ...
    for vid in INPUT_DIR.iterdir():
        ...
        print(f"  Cropped video saved: {cropped_video_path.name}")
